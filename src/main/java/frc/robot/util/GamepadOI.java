...
public class GamepadOI extends OI {
    ...
    void initializeButtons() {
        ...
        // Cargo
        armUp = new JoystickButton(secondaryJoystick, BUTTON4);
        armDown = new JoystickButton(secondaryJoystick, BUTTON8);
        wheelOut = new JoystickButton(secondaryJoystick, BUTTON1);
        wheelIn = new JoystickButton(secondaryJoystick, BUTTON2);
    }
